...
public class UmbralItems {
    ...
    public static final RegistryObject<GlovesItem> PHANTOM_GLOVES = ITEMS.register("phantom_gloves", () -> new UmbralGloves(1, "phantom", () -> SoundEvents.ARMOR_EQUIP_GENERIC, new Item.Properties().stacksTo(1).durability(TwilightArmorMaterial.ARMOR_PHANTOM.getDurabilityForType(ArmorItem.Type.BOOTS)).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<AetherTrophyItem> SLIDER_TROPHY = ITEMS.register("slider_trophy", () -> new AetherTrophyItem(new Item.Properties(), UmbralBlocks.SLIDER_TROPHY_BLOCK, UmbralBlocks.SLIDER_WALL_TROPHY_BLOCK));
    public static final RegistryObject<AetherTrophyItem> VALKYRIE_QUEEN_TROPHY_ENTITY = ITEMS.register("valkyrie_queen_trophy", () -> new AetherTrophyItem(new Item.Properties(), UmbralBlocks.VALKYRIE_QUEEN_TROPHY_BLOCK, UmbralBlocks.VALKYRIE_WALL_QUEEN_TROPHY_BLOCK));
    public static final RegistryObject<AetherTrophyItem> SUN_SPIRIT_TROPHY_ENTITY = ITEMS.register("sun_spirit_trophy", () -> new AetherTrophyItem(new Item.Properties(), UmbralBlocks.SUN_SPIRIT_TROPHY_BLOCK, UmbralBlocks.SUN_SPIRIT_WALL_TROPHY_BLOCK));
}
