...
public class SliderTrophyRenderer implements BlockEntityRenderer<AetherTrophyEntity> {
    ...
    public SliderTrophyRenderer(BlockEntityRendererProvider.Context context) {
        this.sliderModel = new SliderModel(context.bakeLayer(AetherModelLayers.SLIDER));
    ...
    /*public final static class SliderWithoutLevel extends BlockEntityWithoutLevelRenderer {
        public SliderWithoutLevel() {
